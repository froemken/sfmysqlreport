 ...
 */
class VariablesRepository extends \StefanFroemken\Sfmysqlreport\Domain\Repository\AbstractRepository {

	/**
	 * get status from MySql
	 *
	 * @return \StefanFroemken\Sfmysqlreport\Domain\Model\Variables
	 */
	public function findAll() {
		...
		return $this->dataMapper->mapSingleRow('StefanFroemken\\Sfmysqlreport\\Domain\\Model\\Variables', $rows);
	}
